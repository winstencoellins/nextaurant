            ...
            <div className="mt-5 bg-white py-5 px-5 rounded-lg shadow-lg">
                <form>
                    ...
                    <div className="flex flex-col mb-5">
                        ...
                        <input type='text' placeholder='johndoe' className="px-3 py-2 border border-slate-300 rounded-lg text-sm" />
                    </div>

                    <div className="flex flex-col mb-5">
                        <label className="mb-1 text-sm">Email</label>
                        <input type='email' placeholder='johndoe@example.com' className="px-3 py-2 border border-slate-300 rounded-lg text-sm" />
                    </div>
